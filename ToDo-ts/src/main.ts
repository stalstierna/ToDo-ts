    ...
    const toDoHtml = todoList.map((task) =>
      `<li class="toDo_task">
                  ...
                  <div class="toDo_right">
                      <button class="edit_btn" data-id="${task.id}"><img class="img_edit" src="img/edit-svgrepo-com.svg" alt="Edit"></button>
                      <button class="delete_btn" data-id="${task.id}"><img class="img_delete"  src="img/delete-2-svgrepo-com.svg" alt="Delete"></button>
                  </div>
               </li>`
    ).join("")
